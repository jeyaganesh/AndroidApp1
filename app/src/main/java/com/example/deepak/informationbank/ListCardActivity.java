...
public class ListCardActivity extends AppCompatActivity implements View.OnClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        rowItems = new ArrayList<ListCardRowItem>();
        for (int i = 0; i < titles.length; i++) {
            ListCardRowItem item = new ListCardRowItem(images[i], titles[i], descriptions[i]);
            rowItems.add(item);
        }

        listView = (ListView) findViewById(R.id.list);
        ListCardAdapter adapter = new ListCardAdapter(this,
                R.layout.list_card_layout, rowItems);
    ...
    public void onClick(View view) {
        ...
        Intent i = new Intent(ListCardActivity.this,SwipeCardActivity.class);
