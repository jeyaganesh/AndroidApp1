...
public class SelectPreferencesEducationTabFragment extends Fragment implements View.OnClickListener{
    View v;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        v=inflater.inflate(R.layout.select_preference_education_layout, container, false);
