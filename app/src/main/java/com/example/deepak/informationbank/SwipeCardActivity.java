...
public class SwipeCardActivity extends AppCompatActivity
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String[] navigationPagesMain=new String[]{"NEWS","EXAMS","JOBS","Academics","MUSIC","Sports","Others"};
        ...
        //RETRIVE DATA FROM THE DATABASE
        navigationPages=new String[]{"Electrical","Computer","Mechanical","Civil","Information technology"};
        ...
        adapter = new SwipeCardAdapter(SwipeCardActivity.this,News, Author, Date, images);
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_preferences) {
            Intent i = new Intent(SwipeCardActivity.this,SelectPreferencesActivity.class);
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        } else if (id == R.id.nav_card_show) {
            Intent ee = new Intent(SwipeCardActivity.this,ImageCardActivity.class);
            startActivity(ee);
        ...
        else if (id == R.id.nav_show_event) {
            Intent se = new Intent(SwipeCardActivity.this,ListCardActivity.class);
