...
public class SelectPreferencesOthersTabFragment extends Fragment implements View.OnClickListener{
    CheckedTextView checkb[]=new CheckedTextView[15];
    View v;
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        View v=inflater.inflate(R.layout.select_preference_others_layout, container, false);
